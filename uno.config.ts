...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'app-sidebar': 'w-[35%] shrink-0 flex flex-col min-h-0 border-r border-app-separator pt-6 pb-6 pl-3 pr-2',
    'app-main-area': 'flex-1 flex flex-col min-w-0 min-h-0',
    'app-statusbar': 'h-10 shrink-0 px-3 flex items-center gap-0.5 border-t border-app-separator',
    'app-card': 'bg-app-surface border border-app-separator rounded-xl',
